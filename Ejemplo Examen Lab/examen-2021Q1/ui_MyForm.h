...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(radioButton, SIGNAL(toggled(bool)), widget, SLOT(setPerspectiveCamera(bool)));
        QObject::connect(widget, SIGNAL(changedPerspectiveCamera(bool)), radioButton, SLOT(setChecked(bool)));
        QObject::connect(spinBox, SIGNAL(valueChanged(int)), widget, SLOT(setCube(int)));
        QObject::connect(widget, SIGNAL(changedCube(int)), spinBox, SLOT(setValue(int)));
